//2.2.6: Solve Equation
package hust.soict.dsai.lab01;

import java.util.Scanner;
public class Ex2_2_6_SolvingEquation{
//Hàm void giải phương trình bậc nhất 1 ẩn ax+b=0 => x=-b/a
  private static void firstDegreeOneVar(){
    ...
    if(a==0 && b==0) System.out.print("The equation has infinitely many solution.\n");
    else if (a==0 && b!=0) System.out.print("The equation has no solution.\n");
    else System.out.print("The equation has a unique solution: x=" + -b/a +".\n");
  }
...
//Xét trường hợp a!=0
  ...
  private static void secondDegreeOneVar(){
    ...
    if(a==0) {
      if(c==0 && b==0) System.out.print("The equation has infinitely many solution.\n");
      else if (b==0 && c!=0) System.out.print("The equation has no solution.\n");
      else System.out.print("The equation has a unique solution: x=" + -c/b +".\n");
      return;
    }
    ...
    if(delta < 0) {
        ...
        System.out.println("The system of equations has a unique solution: x1=" + (-b + Math.sqrt(delta))/(2*a) 
